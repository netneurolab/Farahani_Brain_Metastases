...
all_data = np.load(path_perfusion + 'arrival_all_vertex.npy')
...
plt.show()
np.save(path_results + 'blood_arrival_similarity_432.npy', corr_similarity)
...
plt.show()
np.save(path_results + 'zscored_blood_arrival_similarity_432.npy', corr_similarity)
